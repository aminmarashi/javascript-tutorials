...
describe('monster', () => {
    ...
    it('should return the stats of the monster', () => {
        expect(monster.getMonsterStats()).toEqual('This is an enemy of type troll with 100 health points.');
        expect(monster.getHP()).toEqual(100);

        monster = new Monster('dragon', 200);
        expect(monster.getMonsterStats()).toEqual('This is an enemy of type dragon with 200 health points.');
...
describe('goblin', () => {
    ...
    it('should return the stats of the goblin', () => {
        expect(monster.getMonsterStats()).toEqual('This is a healthy goblin with 100 health points.');
        expect(monster.getHP()).toEqual(100);

        monster = new Goblin(50);
        expect(monster.getMonsterStats()).toEqual('This is a wounded goblin with 50 health points.');
        expect(monster.getHP()).toEqual(50);
