...
describe('fight', () => {
    it('should battle and kill goblin', () => {
        ...
        expect(goblin.getMonsterStats()).toEqual('This is a healthy goblin with 100 health points.');

        battle.dealDamage(goblin);
        expect(goblin.getMonsterStats()).toEqual('This is a wounded goblin with 50 health points.');
